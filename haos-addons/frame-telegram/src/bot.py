...
def main() -> None:
    ...
    # Create the shared dir eagerly so it exists as soon as the bot starts,
    # rather than only on the first photo (matters for wrappers like the HAOS
    # add-ons, which mount this path and may run the pipeline processor
